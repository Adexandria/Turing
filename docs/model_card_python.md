...
A fine-tuned CodeBERTa model designed for the multi-label classification of source code comments, capable of identifying various comment types (e.g., Summary, Ownership, Deprecation, ...) in Python programming language.
...
| :--- | :--- | :--- | :--- | :--- |
| 0 | Usage | 0.70 | 0.70 | 0.70 |
| 1 | Parameters | 0.81 | 0.76 | 0.79 |
| 2 | Development Notes | 0.46 | 0.38 | 0.41 |
| 3 | Expand | 0.38 | 0.37 | 0.38 |
| 4 | Summary | 0.69 | 0.59 | 0.64 |
|  | **Weighted Avg** | **0.65** | **0.61** | **0.63** |

**Python Test Metrics:**

- **Accuracy:** 0.5276
- **F1-Score (Micro):** 0.6333
